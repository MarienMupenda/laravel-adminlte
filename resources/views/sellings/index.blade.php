                    ...
                    <div class="row">
                        <div class="col-lg-3">
                            <div class="single_analite_content">
                                <h4>Total</h4>
                                <h3>{{Auth::user()->currency()}} <span
                                        class="counter">{{number_format($total_j)}}</span>
                                </h3>
                        ...
                        <div class="col-lg-3">
                            <div class="single_analite_content">
                                <h4>Paid</h4>
                                <h3>{{Auth::user()->currency()}} <span
                                        class="counter">{{number_format($total_paid_j)}}</span></h3>
                        ...
                        <div class="col-lg-3">
                            <div class="single_analite_content">
                                <h4>Profits</h4>
                                <h3>{{Auth::user()->currency()}} <span
                                        class="counter">{{number_format($benefice_j)}}</span></h3>
        ...
        <div class="col-12">
            <div class="page_title_box d-flex flex-wrap align-items-center justify-content-between">
                ...
                <div class="page_title_right">
                    ...
                    <button onclick="printIt('commandes')" href="#" class="white_btn mb_10"><i
                                ...
                                <div class="QA_table mb-0">
                                    ...
                                    <table class="table lms_table_active2  ">
                                        ...
                                        @foreach($sellings as $selling)
                                            ...
                                            @else
                                                <tr class="fd"
                                                    onclick="window.location.href='{{route('sellings.show',$selling)}}'">
                                                    @endif
                                                    ...
                                                    <td class="fd">
                                                        <div class="table-data-feature">
                                                            <a href="{{route('sellings.show',$selling)}}" class="item"
                                                               data-toggle="tooltip" data-placement="top" title=""
                                                               data-original-title="Voir plus">
                                                                <i class="zmdi zmdi-more"></i>
                                                            </a>

                                                            @if (Auth::user()->isAdmin() AND !$selling->paid)
                                                                <form method="post" class="pull-right"
                                                                      action="{{route('sellings.destroy',$selling)}}">
                                                                    @csrf @method('DELETE')
