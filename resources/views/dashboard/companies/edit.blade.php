            ...
            <div class="card-body">
                <form action="{{route("companies.update",$company)}}" enctype="multipart/form-data" method="POST"
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-12 col-md-9">
                            <input placeholder="Nom de l'entreprise" id="name" type="text" class="form-control "
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-12 col-md-9">
                            <textarea id="name" rows="5" class="form-control ckeditorx"
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-12 col-md-9">
                            <input type="file" id="text-input" accept="image/x-png,image/gif,image/jpeg" name="logo"
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-12 col-md-9">
                            <select @if ($company->sellings->count()>0) readonly @endif name="currency_id" id="select"
        ...
        <div class="card">
            <div class="card-body">
                @if($company->contact!=null)
                    <form action="{{route("contacts.update",$company->contact)}}" method="POST" class="form-horizontal">
                        @csrf @method('PUT')
                        @else
                            <form action="{{route("contacts.store")}}" method="POST" class="form-horizontal">
                                ...
                                <div class="form-group row">
                                    <label for="name" class="col col-md-3 col-form-label text-md-right"><i
                                            class="zmdi zmdi-phone"></i> <i
                                            class="zmdi zmdi-whatsapp"></i> {{ __('Tel (Whatsapp)') }} <strong
                                    ...
                                    <div class="col-12 col-md-9">
                                        <div class="input-group mb-3">
                                            ...
                                            <input placeholder="243970966587" required id="address" type="number"
                                ...
                                <div class="form-group row">
                                    <label for="name" class="col col-md-3 col-form-label text-md-right"><i
                                            class="zmdi zmdi-email"></i> {{ __('E-mail') }}</label>
                                    <div class="col-12 col-md-9">
                                        <input id="address" type="email" placeholder="contact@smirl.org"
                                ...
                                <div class="form-group row">
                                    <label for="name" class="col col-md-3 col-form-label text-md-right"><i
                                            class="zmdi zmdi-globe"></i> {{ __('Website') }}</label>
                                    <div class="col-12 col-md-9">
                                        <div class="input-group mb-3">
                                            <div class="input-group-prepend">
                                                <span class="input-group-text" id="basic-addon3">https://</span>
                                            </div>
                                            <input placeholder="www.smirl.org" name="website" class="form-control"
                                ...
                                <div class="form-group row">
                                    <label for="name" class="col col-md-3 col-form-label text-md-right"><i
                                            class="zmdi zmdi-instagram"></i> {{ __('Instagram') }}</label>
                                    <div class="col-12 col-md-9">
                                        <div class="input-group mb-3">
                                            <div class="input-group-prepend">
                                            ...
                                            <input name="instagram" placeholder="smirl_tech" type="text"
                                ...
                                <div class="form-group row">
                                    <label for="name" class="col col-md-3 col-form-label text-md-right"><i
                                            class="zmdi zmdi-facebook-box"></i> {{ __('Facebook') }}</label>
                                    <div class="col-12 col-md-9">
                                        <div class="input-group mb-3">
                                            <div class="input-group-prepend">
                                                <span class="input-group-text"
                                            ...
                                            <input name="facebook" placeholder="SmirlTech" type="text"
                                                   class="form-control" id="basic-url" aria-describedby="basic-addon3"
                                ...
                                <div class="form-group row">
                                    <label for="name" class="col col-md-3 col-form-label text-md-right"><i
                                            class="zmdi zmdi-twitter-box"></i> {{ __('Twitter') }}</label>
                                    <div class="col-12 col-md-9">
                                        <div class="input-group mb-3">
                                            <div class="input-group-prepend">
                                                <span class="input-group-text"
                                            ...
                                            <input placeholder="SmirlTech" name="twitter" type="text"
                                                   class="form-control" id="basic-url" aria-describedby="basic-addon3"
                                                   value="{{$company->contact->twitter??""}}">
                                        </div>
                                    </div>
                                </div>

                                <div class="form-group row">
                                    <label for="name" class="col col-md-3 col-form-label text-md-right"></i> <i
                                            class="zmdi zmdi-linkedin-box"></i> {{ __('Linkedin') }}</label>
                                    <div class="col-12 col-md-9">
                                        <div class="input-group mb-3">
                                            <div class="input-group-prepend">
                                                <span class="input-group-text" id="basic-addon3">https://linkedin.com/company/</span>
                                            </div>
                                            <input placeholder="smirltech" name="linkedin" type="text"
                                                   class="form-control" id="basic-url" aria-describedby="basic-addon3"
