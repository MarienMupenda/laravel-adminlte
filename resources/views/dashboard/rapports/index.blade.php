        ...
        <div class="page_title_box d-flex flex-wrap align-items-center justify-content-between">
            ...
            <div class="page_title_right">
                <div class="mr_5 mb_10 form-inline">
                    @csrf @method('GET')
                    <input id="from" onchange="readyLink()" class="form-control" type="date" value="{{$from->format('Y-m-d')}}">
                    <input id="to" onchange="readyLink()" class="form-control" type="date" value="{{$to->format('Y-m-d')}}">
                    ...
                    <div hidden class="card-header">
                        <div class="box_header m-0">
                            ...
                            <div class="erning_btn d-flex">
                                <button onclick="printIt('commandes')" href="#" class="btn btn-outline-primary btn-sm"><i class="fa fa-print"></i></button>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="QA_section">
                            <div hidden class="text-center w3-margin-bottom">
                                <div class="row text-justify w3-margin-bottom">
                                    <div class="col-lg-4">
                                        <img class="img-fluid" style="height: 100px; width: auto" src="{{asset(auth()->user()->company->logo())}}" />
                                    </div>
                                    <div class="col-lg-4">
                            ...
                            <div class="QA_table mb-0">
                                <x-adminlte-datatable id="table7" :heads="$heads" theme="light" :config="$config" with-footer striped hoverable with-buttons />
                                <!-- table-responsive -->
                            </div>
                        </div>
                    </div>
...
<script>
    ...
    function readyLink() {
        ...
        var url = currentUrl + '/dashboard/rapports/' + $('#from').val() + '/' + $('#to').val();
