            ...
            <div class="row g-2">
                ...
                <div class="col-lg-3 col-6">
                    ...
                    <div class="small-box bg-success">
                        ...
                        <a href="{{route('dashboard.rapports')}}" class="small-box-footer">
                ...
                <div class="col-lg-3 col-6">
                    ...
                    <div class="small-box bg-danger">
                        ...
                        <a href="{{route('dashboard.items.index')}}" class="small-box-footer">
                            {{ __('More info') }} <i class="fas fa-arrow-circle-right"></i>
                        </a>
                    </div>
                </div>
                            ...
                            <div class="pt-0 pb-0 card-body h-100">
                                <div class="row g-0 h-100 align-content-center">
                                    <div class="mb-2 col-12 col-md-6 d-flex align-items-center mb-md-0">
                                        <a href="{{route('dashboard.items.edit',$item)}}">{{ $item->name }}</a>
                                    </div>
    ...
    <div class="mb-5 col-xl-6">
        <div class="d-flex">
            <div class="dropdown-as-select me-3" data-setactive="false" data-childselector="span">
                <a class="pt-0 align-top pe-0 lh-1 dropdown-toggle" href="#" data-bs-toggle="dropdown" aria-expanded="false" aria-haspopup="true">
        ...
        <div class="card sh-45 h-xl-100-card">
            <div class="card-body h-100">
                <div class="h-100">
                    ...
                    <div class="p-3 border rounded-md opacity-0 custom-tooltip position-absolute bg-foreground border-separator pe-none d-flex z-index-1 align-items-center basic-transform-transition">
                        <div class="align-middle border icon-container d-flex align-items-center justify-content-center align-self-center rounded-xl sh-5 sw-5 me-3">
                    ...
                    <div class="pt-0 pb-0 card-body h-100">
                        <div class="row g-0 h-100 align-content-center">
                            <div class="mb-3 col-10 col-md-4 d-flex align-items-center mb-md-0 h-md-100">
                                <a href="{{route('dashboard.sellings.show',$order)}}" class="body-link stretched-link">Order
                                    #{{$order->id}}</a>
                            </div>
                            <div class="mb-1 col-2 col-md-3 d-flex align-items-center text-muted mb-md-0 justify-content-end justify-content-md-start">
                            ...
                            <div class="mb-1 col-12 col-md-3 d-flex align-items-center justify-content-md-end mb-md-0 text-alternate">
