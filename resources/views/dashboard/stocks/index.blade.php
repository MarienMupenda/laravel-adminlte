    ...
    <div hidden class="row">
        <div class="col-md-12">
            <div class="overview-wrap">
                ...
                <a href="{{route('dashboard.stocks.create')}}" class="au-btn au-btn-icon au-btn--blue">
        ...
        <div class="table-responsive m-b-40">
            <table class="table table-borderless table-data3">
                ...
                @foreach($stocks as $stock)
                    <tr onclick="window.location.href='{{route('dashboard.items.edit',$stock->item)}}#bloc-stock'">
                        <td>{{$stock->id}}</td>
