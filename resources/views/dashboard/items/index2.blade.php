                                ...
                                <div class="ps-5 pe-4 h-100">
                                    <div class="row g-0 h-100 align-content-center">
                                        ...
                                        <div
                                            ...
                                            <div class="lh-1 text-alternate">{{$item->qty()}}</div>
                                        </div>
                                        <div
                                            class="col-12 col-lg-3 d-flex flex-column pe-1 mb-2 mb-lg-0 justify-content-center order-4">
                                            <div class="lh-1 text-alternate">{{$item->price()}}</div>
                                        </div>
                                        <div
                                            class="col-12 col-lg-2 d-flex flex-column pe-1 mb-2 mb-lg-0 align-items-start justify-content-center order-5">
                                            <span class="badge bg-outline-primary group">{{$item->status()}}</span>
                                        </div>
                                        <div
                                            class="col-1 d-flex flex-column mb-2 mb-lg-0 align-items-end order-{{$item->id}} order-lg-last justify-content-lg-center">
