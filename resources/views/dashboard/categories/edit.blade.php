    ...
    @if(auth()->user()->isSuperAdmin())
        <div class="card">
            ...
            <div class="card-body card-block">
                <form action="{{route("dashboard.categories.update",$category)}}" method="POST" class="form-horizontal">
                    @csrf @method('PUT')
                    <div class="row form-group">
                        ...
                        <div class="col-12 col-md-9">
                            <input type="text" value="{{$category->name}}" id="text-input" name="name" class="form-control">
                        </div>
                    </div>
                    <div class="row form-group">
                        <div class="col col-md-3">
                        ...
                        <div class="col-12 col-md-9">
                            <input type="text" value="{{$category->icon}}" id="text-input" name="icon" class="form-control">
                        </div>
                    </div>
