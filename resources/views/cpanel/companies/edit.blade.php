...
<div class="card mb-7">
    <div class="card-body">
        <form action="{{route("admin.companies.update",$company)}}" enctype="multipart/form-data" method="POST" class="form-horizontal">
            @csrf @method('PUT')
            ...
            <div class="form-group row">
                <label for="select" class="col col-md-3 col-form-label text-md-right">Etat</label>
                <div class="col-12 col-md-9">
                    <select name="state" id="select" class="form-control form-select">
                        <option @if ($company->state=="pending")
                            selected
                            @endif value="pending"> Pending</option>
                        <option @if ($company->state=="active")
                            selected
                            @endif value="active"> Active</option>
                        <option @if ($company->state=="disabled")
                            selected
                            @endif value="disabled">Disabled</option>
