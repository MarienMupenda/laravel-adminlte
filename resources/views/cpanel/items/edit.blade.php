            ...
            <div class="card-header">
                <div class="box_header m-0">
                    ...
                    <div class="erning_btn d-flex">
                        <a href="{{ route('dashboard.items.index') }}" class="btn btn-outline-primary btn-sm"><i class="fas fa-chevron-left"></i></a>
                    </div>
                </div>
            </div>
            <div class="card-body">
                    ...
                    <div class="row">
                        <div class="col-md-3 border-right">
                            <div class="d-flex flex-column align-items-center text-center p-3 py-5">
                                <img id="img-view" width="150px" height="auto" src="{{$item->image_small()}}" class="img-fluid mt-5">
                                @if(auth()->user()->isAdmin() and $item->sellingDetails->count()==0)
                                <form method="post" class="pull-right" action="{{route('dashboard.items.destroy',$item)}}">
                                    @csrf @method('DELETE')

                                    <button type="submit" class="btn btn-outline-danger btn-icon btn-icon-start w-100 w-md-auto float-right">
                        ...
                        <div class="col-md-5 border-right">
                            <div class="p-3 py-5">
                                ...
                                <form action="{{route("dashboard.items.update",$item)}}" enctype="multipart/form-data" method="POST" class="form-horizontal">
                                    @csrf @method('PUT')
                                    ...
                                    <div class="row form-group">
                                        ...
                                        <div class="col-12">
                                            <input type="text" id="text-input" name="name" value="{{$item->name}}" placeholder="Text" class="form-control">
                                        </div>
                                    </div>
                                    <div class="row form-group">
                                        ...
                                        <div class="col-12 col-md-12">
                                            <div class="input-group mb-3">
                                                ...
                                                <input readonly type="number" id="barcode" name="barcode" value="{{$item->barcode}}" placeholder="Scanner le produit pour remplir" class="form-control">
                                    ...
                                    <div class="row form-group">
                                        ...
                                        <div class="col-12">
                                            <input type="file" id="img-file" accept="image/x-png,image/gif,image/jpeg" name="image" class="form-control form-control-file mb-2">

                                            <input name="image_url" onpaste="return true;" type="url" id="img-url" placeholder="https://" class="form-control">
                                        </div>
                                    ...
                                    <div class="row form-group">
                                        ...
                                        <div class="col-12">
                                            <textarea minlength="1O" maxlength="600" onpaste="return true;" class="form-control" rows="5" type="text" id="text-inputx" name="description">{{$item->description}}</textarea>
                                        </div>
                                    </div>
                                    <div class="row form-group">
                                    ...
                                    <div class="row form-group">
                                        ...
                                        <div class="col-12 col-lg-10">
                                            <div class="input-group mb-3">
                                                ...
                                                <input type="text" id="amount" name="pv" value="{{$item->selling_price}}" placeholder=".." class="form-control">
                                                <div class="input-group-append">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-12">
                                            <div class="input-group mb-3">
                                                ...
                                                <input min="1" required type="number" aria-describedby="basic-addon3" name="qty" class="form-control">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-12">
                                            <div class="input-group mb-3">
                                                ...
                                                <input min="1" max="{{$item->selling_price}}" required type="number" id="amount" name="pa" value="{{$item->selling_price}}" class="form-control">
