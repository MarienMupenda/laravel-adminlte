...
<div class="card">
    <div class="card-body card-block">
        <form action="{{route("dashboard.items.store")}}" enctype="multipart/form-data" method="POST" class="form-horizontal">
            @csrf @method('POST')
            <div class="row form-group">
                ...
                <div class="col-12 col-md-9">
                    <input type="text" id="text-input" required name="name" placeholder="Article | Service" class="form-control">
                </div>
            </div>
            <div class="row form-group">
                <div class="col col-md-3">
                ...
                <div class="col-12 col-md-9">
                    <textarea onpaste="return true;" minlength="1O" maxlength="600" class="form-control" rows="3" type="text" id="text-input" name="description"></textarea>
                </div>
            </div>
            <div class="row form-group">
                <div class="col col-md-3">
            ...
            <div class="row form-group">
                ...
                <div class="col-12 col-md-9">
                    <div class="mb-3 input-group">
                        ...
                        <input readonly type="number" id="barcode" name="barcode" placeholder="Scanner le produit pour remplir" class="form-control">
            ...
            <div class="row form-group">
                ...
                <div class="col-12 col-md-9">
                    <div class="mb-3 input-group">
                        ...
                        <input required type="number" id="amount" name="pv" placeholder=".." class="form-control">
                        <div class="input-group-append">
            ...
            <div class="row form-group">
                ...
                <div class="col-12 col-md-9">
                    <input type="file" id="text-input" accept="image/x-png,image/gif,image/jpeg" name="image" class="form-control form-control-file">
                </div>
            ...
            <div class="card-footer">
                <a href="{{route("dashboard.items.index")}}" class="btn btn-outline-primary btn-sm">
